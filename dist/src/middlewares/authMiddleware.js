...
export function signInMiddleware(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var inputData, user, validPassword;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    inputData = req.body;
                    return [4 /*yield*/, validateUser(inputData.email)];
                case 1:
                    user = _a.sent();
                    validPassword = bcrypt.compareSync(inputData.password, user.password);
                    if (!validPassword) {
