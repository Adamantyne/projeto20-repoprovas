...
var JWTDataValidate = function (input) {
    return typeof input === "object" && "email" && "id" in input;
};
export function throwErr(type, message) {
...
export function validateToken(token) {
    try {
        var jwtData = jwt.verify(token, process.env.JWT_SECRET);
...
export function validateUser(email, id) {
    return __awaiter(this, void 0, void 0, function () {
        var errorMessage, validUser, validUser;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    errorMessage = "unregistered email/token";
                    if (!id) return [3 /*break*/, 2];
                    return [4 /*yield*/, userRepository.findByEmailAndId(email, id)];
                case 1:
                    validUser = _a.sent();
                    if (!validUser) {
                        throwErr("unauthorized", errorMessage);
                    }
                    return [2 /*return*/, validUser];
                case 2: return [4 /*yield*/, userRepository.findByEmail(email)];
                case 3:
                    validUser = _a.sent();
                    if (!validUser) {
                        throwErr("unauthorized", errorMessage);
