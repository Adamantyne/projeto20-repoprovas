/*
  ...
  - You are about to drop the `teachersDisciplinies` table. If the table is not empty, all the data it contains will be lost.
...
-- DropForeignKey
ALTER TABLE "teachersDisciplinies" DROP CONSTRAINT "teachersDisciplinies_teacherId_fkey";

-- DropForeignKey
ALTER TABLE "tests" DROP CONSTRAINT "tests_teacherDisciplineId_fkey";

-- DropTable
DROP TABLE "teachersDisciplinies";
